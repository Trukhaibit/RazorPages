...
namespace RazorPages.Migrations
{
    ...
    [Migration("20211031194953_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 15, 49, 53, 121, DateTimeKind.Local).AddTicks(3918),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2021, 10, 31, 15, 49, 53, 123, DateTimeKind.Local).AddTicks(6600),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 15, 49, 53, 123, DateTimeKind.Local).AddTicks(6650),
                            ServicesID = 5
                        });
                });
